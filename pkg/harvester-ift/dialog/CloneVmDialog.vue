...
export default {
  ...
  created() {
    //  get the vm name
    this.vmName = this.resources[0].metadata.name;
    // get the status
    this.alertMsgEnabled = this.resources[0].status.printableStatus === 'Running';
  },
  ...
  <Card :show-highlight-border="false">
    ...
    <template #body>
      ...
      <div
        ...
        class="errorMsg"
      >
        {{ t('harvester.modal.cloneVM.message.error',{ name: vmName}) }}
      </div>
    </template>
    ...
    >
      <div class="buttons">
        ...
        <AsyncButton
          ...
          :disabled="(cloneData && !name)||alertMsgEnabled"
          @click="create"
        />
      </div>
