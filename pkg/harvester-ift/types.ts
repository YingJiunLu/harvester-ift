export const HCI = {
  ...
  RESTORE:            'snapshot.kubevirt.io.virtualmachinerestore',
  ...
  VM_SNAPSHOT:        'snapshot.kubevirt.io.virtualmachinesnapshot',
  ...
  GPU_MODE:           'gpu.infortrend.com/vm-gpu-mode',
};

export const VOLUME_SNAPSHOT = 'snapshot.storage.k8s.io.volumesnapshot';

// Register the name of the store
